...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function (exports) {
  ...
  var $ = layui.$
      ...
      , thisTable = function () {
          ...
          return {
              refresh: function (options, page) {
                  options = options || {};
                  page = page || 1;
                  $.extend(that.config, options);
                  that.pullData.call(that, page);
              },
  ...
  // 表格刷新数据
  Class.prototype.refresh = function (options, page) {
      var that = this;
      options = options || {};
      page = page || 1;
      $.extend(that.config, options);
  ...
  // 刷新数据
  table.refresh = function (id, options, page) {
      options = options || {};
      page = page || 1;

      var _that = thisTable.that[id];
      if (_that) {
          _that.refresh(options, page);
      }
  };
